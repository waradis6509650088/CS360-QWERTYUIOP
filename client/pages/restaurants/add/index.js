    ...
    <form id="restaurantForm" onSubmit={handleSubmit}>
      ...
      <div className="grid md:grid-cols-3 md:gap-6"> 
          ...
          <div>
              ...
              >
                  <option disabled selected>Choose your price range</option>
          ...
          <div>
              ...
              >
                  <option disabled selected>What kind of food do you have?</option>
                  <option value="american">American</option>
                  <option value="chinese">Chinese</option>
                  <option value="dinner_bar">Dinner Bar</option>
